...
static const RemminaProtocolSetting remmina_rdp_advanced_settings[] =
{
	...
	{ REMMINA_PROTOCOL_SETTING_TYPE_TEXT,	    "serialname",	       N_("Local serial name"),			TRUE,	NULL,		NULL},
	{ REMMINA_PROTOCOL_SETTING_TYPE_TEXT,	    "serialdriver",	       N_("Local serial driver"),		TRUE,	NULL,		NULL},
	{ REMMINA_PROTOCOL_SETTING_TYPE_TEXT,	    "serialpath",	       N_("Local serial path"),			TRUE,	NULL,		NULL},
	{ REMMINA_PROTOCOL_SETTING_TYPE_TEXT,	    "parallelname",	       N_("Local parallel name"),		TRUE,	NULL,		NULL},
	{ REMMINA_PROTOCOL_SETTING_TYPE_TEXT,	    "parallelpath",	       N_("Local parallel driver"),		TRUE,	NULL,		NULL},
