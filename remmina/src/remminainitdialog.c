...
static void
remmina_init_dialog_class_init (RemminaInitDialogClass *klass)
{
}

static void
remmina_init_dialog_destroy (RemminaInitDialog *dialog, gpointer data)
{
    g_free (dialog->title);
...
static void
remmina_init_dialog_init (RemminaInitDialog *dialog)
{
    GtkWidget *hbox;
    GtkWidget *widget;
...
static void
remmina_init_dialog_connecting (RemminaInitDialog *dialog)
{
...
GtkWidget*
remmina_init_dialog_new (const gchar *title_format, ...)
{
...
void
remmina_init_dialog_set_status (RemminaInitDialog *dialog, const gchar *status_format, ...)
{
    va_list args;
...
void
remmina_init_dialog_set_status_temp (RemminaInitDialog *dialog, const gchar *status_format, ...)
{
    va_list args;
    gchar *s;
...
static GtkWidget*
remmina_init_dialog_create_file_button (GtkTable *table, const gchar *label, gint row, const gchar *filename)
{
    GtkWidget *widget;
    gchar *pkidir;
