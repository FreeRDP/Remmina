...
void remmina_pref_init(void)
{
	...
	if (g_key_file_has_key(gkeyfile, "remmina_pref", "tray_icon_light", NULL))
		remmina_pref.tray_icon_light = g_key_file_get_boolean(gkeyfile, "remmina_pref", "tray_icon_light", NULL);
	else
		remmina_pref.tray_icon_light = FALSE;
...
void remmina_pref_save(void)
{
	...
	g_key_file_set_boolean(gkeyfile, "remmina_pref", "tray_icon_light", remmina_pref.tray_icon_light);
